...
{
    // Declara��o impl�cita de um array de inteiros
    ...
    // Declara��o expl�cita de um array de strings
    ...
    // Declara��o impl�cita de um array bidimensional de inteiros
    ...
    // Declara��o expl�cita de um array multidimensional de inteiros
    ...
    // Quero adicionar o n�mero 50 ao final do array
    ...
    // Adicionar o n�mero 66 no final do array
...
app.MapGet("/aula_2_list", () =>
{
    ...
    // E aqui de b�nus j� tem uma forma de percorrer a lista
...
app.MapGet("/aula_2_ex_1", () =>
{
    ...
    for (int i = 0; i < 5; i++)
    {
        Console.WriteLine("A capital brasileira de n�mero {0} �: {1}", i + 1, capitais[i]);
    }
});
...
app.MapGet("/aula_2_ex_2", () =>
{
    ...
    for (int i = 0; i < 3; i++)
    {
        for (int j = 0; j < 4; j++)
        {
            Console.WriteLine("O elemento [{0}, {1}] da matriz �: {2}", i, j, matriz[i, j]);
        }
    }
});
...
app.MapGet("/aula_3_dict", () =>
{
    ...
    // Porém observem que se não existir a chave, vai retornar uma exceção
    ...
    if (possuiValor == true){
        ...
        Console.WriteLine("A chave 'nova chave' não está cadastrada.");
    }
    ...
    if (possuiValor == true){
        ...
        Console.WriteLine("A chave 'outra chave' não está cadastrada.");
    }
    Console.Clear();
