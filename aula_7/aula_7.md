...
As *threads* podem ser ententidas como processos mais leves, que possuem um espaço de memória compartilhado, cooperam entre si por tempo de CPU, compartilham também os dados e existem **dentro** de um processo.
